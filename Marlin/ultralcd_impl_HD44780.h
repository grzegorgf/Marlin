...
// spenser cycle icon
  ...
  const static PROGMEM byte stepicon[8] = {
    B10001,
    B11001,
    B11101,
    B11111,
  ...
  const static PROGMEM byte progicon[8] = {
    B11000,
    B10100,
    B11000,
    B10111,
  ...
  /*const static PROGMEM byte cycleicon[8] = {
    B00100,
    B01110,
    B10100,
    B10001,
  ...
  createChar_P(LCD_BEDTEMP_CHAR, degree);//bedTemp);
  createChar_P(LCD_DEGREE_CHAR, degree);
  createChar_P(LCD_STR_THERMOMETER[0], thermometer);
  createChar_P(LCD_FEEDRATE_CHAR, stepicon);
  createChar_P(LCD_CLOCK_CHAR, clock);
  createChar_P(LCD_PROGICON, progicon);
  //createChar_P(LCD_CYCLEICON, );
 // createChar_P(LCD_STEPICON, );
  #if ENABLED(SDSUPPORT)
    #if ENABLED(LCD_PROGRESS_BAR)
...
void lcd_printPGM_utf(const char *str, uint8_t n=LCD_WIDTH) {
  ...
  static void logo_lines(const char* const extra) {
    ...
    lcd.setCursor(indent, 1);                    lcd_printPGM(PSTR("|SPENSER|"));  lcd_printPGM(extra);
...
static void lcd_implementation_status_screen() {
  ...
  /*lcd.setCursor(0, LCD_HEIGHT - 2);
   ...
   /* static bool last_blink = false;
    ...
    /* idle
     * coupling 8 znaků max
     * capping
     * washing
     * cleaving
     * 1d 25:05 8 + 1 + ikona = 10
     */
  #else
    lcd.setCursor(0, 0);
    lcd.print(lcd_status_message[0]);//lcd_print_utf(lcd_status_message);
    lcd.setCursor(1, 0);
    lcd.print(lcd_status_message[1]);
    lcd.setCursor(2, 0);
    lcd.print(lcd_status_message[2]);
        lcd.setCursor(3, 0);
    lcd.print(lcd_status_message[3]);
        lcd.setCursor(4, 0);
    lcd.print(lcd_status_message[4]);
        lcd.setCursor(5, 0);
    lcd.print(lcd_status_message[5]);
        lcd.setCursor(6, 0);
    lcd.print(lcd_status_message[6]);
        lcd.setCursor(7, 0);
    lcd.print(lcd_status_message[7]);
        lcd.setCursor(8, 0);
    lcd.print(lcd_status_message[8]);
        lcd.setCursor(9, 0);
    lcd.print(lcd_status_message[9]);
        lcd.setCursor(10, 0);
    lcd.print((char)LCD_CLOCK_CHAR);
    //lcd.print(lcd_status_message[10]);
        lcd.setCursor(11, 0);
    lcd.print(lcd_status_message[11]);
        lcd.setCursor(12, 0);
    lcd.print(lcd_status_message[12]);
        lcd.setCursor(13, 0);
    lcd.print(lcd_status_message[13]);
        lcd.setCursor(14, 0);
    lcd.print(lcd_status_message[14]);
        lcd.setCursor(15, 0);
    lcd.print(lcd_status_message[15]);
        lcd.setCursor(16, 0);
    lcd.print(lcd_status_message[16]);
        lcd.setCursor(17, 0);
    lcd.print(lcd_status_message[17]);
        lcd.setCursor(18, 0);
    lcd.print(lcd_status_message[18]);
        lcd.setCursor(19, 0);
    lcd.print(lcd_status_message[19]);
    
    lcd.setCursor(0, 2);
    lcd.print((char)LCD_FEEDRATE_CHAR);
    //lcd.print(lcd_status_message[20]);//lcd_print_utf(lcd_status_message);
    lcd.setCursor(1, 2);
    lcd.print(lcd_status_message[21]);
    lcd.setCursor(2, 2);
    lcd.print(lcd_status_message[22]);
        lcd.setCursor(3, 2);
    lcd.print(lcd_status_message[23]);
        lcd.setCursor(4, 2);
    lcd.print(lcd_status_message[24]);
        lcd.setCursor(5, 2);
    //lcd.print((char)LCD_BEDTEMP_CHAR);
    lcd.print(lcd_status_message[25]);
        lcd.setCursor(6, 2);
    lcd.print(lcd_status_message[26]);
        lcd.setCursor(7, 2);
        lcd.print((char)LCD_BEDTEMP_CHAR);
    //lcd.print(lcd_status_message[27]);
        lcd.setCursor(8, 2);
    lcd.print(lcd_status_message[28]);
        lcd.setCursor(9, 2);
    lcd.print(lcd_status_message[29]);
        lcd.setCursor(10, 2);
    
    lcd.print(lcd_status_message[30]);
        lcd.setCursor(11, 2);
    lcd.print(lcd_status_message[31]);
        lcd.setCursor(12, 2);
    lcd.print(lcd_status_message[32]);
        lcd.setCursor(13, 2);
    lcd.print(lcd_status_message[33]);
        lcd.setCursor(14, 2);
        lcd.print((char)LCD_PROGICON);
    //lcd.print(lcd_status_message[34]);
        lcd.setCursor(15, 2);
    lcd.print(lcd_status_message[35]);
        lcd.setCursor(16, 2);
    lcd.print(lcd_status_message[36]);
        lcd.setCursor(17, 2);
    lcd.print(lcd_status_message[37]);
        lcd.setCursor(18, 2);
    lcd.print(lcd_status_message[38]);
        lcd.setCursor(19, 2);
    lcd.print(lcd_status_message[39]);
    
    lcd.setCursor(0, 3);
    lcd.print(lcd_status_message[40]);//lcd_print_utf(lcd_status_message);
    lcd.setCursor(1, 3);
    lcd.print(lcd_status_message[41]);
    lcd.setCursor(2, 3);
    lcd.print(lcd_status_message[42]);
        lcd.setCursor(3, 3);
    lcd.print(lcd_status_message[43]);
        lcd.setCursor(4, 3);
    lcd.print(lcd_status_message[44]);
        lcd.setCursor(5, 3);
    lcd.print(lcd_status_message[45]);
        lcd.setCursor(6, 3);
    lcd.print(lcd_status_message[46]);
        lcd.setCursor(7, 3);
    lcd.print(lcd_status_message[47]);
        lcd.setCursor(8, 3);
    lcd.print(lcd_status_message[48]);
        lcd.setCursor(9, 3);
    lcd.print(lcd_status_message[49]);
        lcd.setCursor(10, 3);
    lcd.print(lcd_status_message[50]);
        lcd.setCursor(11, 3);
    lcd.print(lcd_status_message[51]);
        lcd.setCursor(12, 3);
    lcd.print(lcd_status_message[52]);
        lcd.setCursor(13, 3);
    lcd.print(lcd_status_message[53]);
        lcd.setCursor(14, 3);
    lcd.print(lcd_status_message[54]);
        lcd.setCursor(15, 3);
    lcd.print(lcd_status_message[55]);
        lcd.setCursor(16, 3);
    lcd.print(lcd_status_message[56]);
        lcd.setCursor(17, 3);
    lcd.print(lcd_status_message[57]);
        lcd.setCursor(18, 3);
    lcd.print(lcd_status_message[58]);
        lcd.setCursor(19, 3);
    lcd.print(lcd_status_message[59]);
    
    lcd.setCursor(17, 1);
    lcd.print(lcd_status_message[60]);
    lcd.setCursor(18, 1);
    lcd.print(lcd_status_message[61]);
    lcd.setCursor(19, 1);
    lcd.print(lcd_status_message[62]);
  #endif
}
