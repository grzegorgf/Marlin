...
#define STRING_CONFIG_H_AUTHOR "SPENSER" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME ""  // hovno
...
#define HEATER_3_MINTEMP -1000
#define HEATER_4_MINTEMP -1000
...
#define HEATER_3_MAXTEMP 1000
#define HEATER_4_MAXTEMP 1000
...
#define E_MIN_ENDSTOP_INVERTING false//true // set to true to invert the logic of the endstop.
#define F_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.

#define E_MAX_ENDSTOP_INVERTING false//true // set to true to invert the logic of the endstop.
#define F_MAX_ENDSTOP_INVERTING false//true // set to true to invert the logic of the endstop.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 265, 690}

/**
 * Default Max Feed Rate (mm/s)  Z: 2000
 * Override with M203
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          {100000, 100000, 2000, 100000}
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {600, 600, 600, 600 }
...
#define Z_HOMING_HEIGHT 60  // (in mm) Minimal z height before homing (G28) for Z clearance above the bed, clamps, ...
